...
/**
 * CollateralAssetCaptureBaseWithId
 */
public class CollateralAssetCaptureBaseWithId   {
  private String collateralAssetReference = null;

  private String collateralAssetCaptureReference = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier      
   * @return collateralAssetCaptureReference
  **/

  public String getCollateralAssetCaptureReference() {
    return collateralAssetCaptureReference;
  }

  public void setCollateralAssetCaptureReference(String collateralAssetCaptureReference) {
    this.collateralAssetCaptureReference = collateralAssetCaptureReference;
  }
